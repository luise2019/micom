    ...
    <div class="topbar-background">
      <div class="topbar-wrapper">
        <ul class="topbar--left">
          ...
          <li class="ser-items download">
            <a href=""
              >下载app
              <div class="box1"></div>
              <span class="qrcode"
                ><img src="../assets/download.png" alt="" />小米商城APP</span
              ></a
            >
          </li>
          <li class="spacer">&nbsp;|&nbsp;</li>
        ...
        <div class="topbar--right">
          ...
          <div class="shop-cart">
            <a href=""
              ><span class="fa fa-shopping-cart"></span> &nbsp;购物车<span
                >(0)</span
              ></a
            >
            <div class="cart-menu">
...
.download .qrcode {
  ...
  text-align: center;
  /* 根据该元素本身的字体大小 设置行高，等于line-height 100% */
  line-height: 1;
  position: absolute;
  top: 40px;
  left: -39px;
...
.header-search .input {
  ...
  /* 容器设置align-items或子项设置align-self: center;实现垂直居中 */
}
.header-search span {
  width: 20%;
  height: 48px;
